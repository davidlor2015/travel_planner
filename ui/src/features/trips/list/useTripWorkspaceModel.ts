...
import { parseTripItineraryPayload } from "../workspace/models/normalizeTripWorkspace";
import type {
  BudgetSummary,
  PackingSummary,
  ReservationSummary,
...
import {
  ...
  getTripDurationDays,
  getTripStatus,
} from "../workspace/helpers/tripDateUtils";
import {
  buildManualItineraryDraft,
  getAiAssistPayload,
  getDefaultRegenerationControls,
  type RegenerationControlState,
} from "../itinerary/tripItineraryDraftWorkspace";
import { buildTripReadinessSnapshot } from "../workspace/models/tripOverviewViewModel";
import {
  createInitialBudgetSummary,
  createInitialPackingSummary,
  createInitialReservationSummary,
} from "../workspace/models/workspaceFallbacks";
import { WORKSPACE_STORAGE_KEY } from "../workspace/persistence/workspacePersistence";
import {
  buildTripActionabilityModel,
  deriveTripActionItems,
  type TripActionDerivationInput,
} from "../workspace/models/deriveTripActionItems";
import {
  buildWorkspaceActivityModel,
  coerceWorkspaceActivitySnapshot,
} from "../workspace/models/workspaceActivityModel";
import { createItineraryDraftMutations } from "../itinerary/itineraryDraftMutations";
import { deriveDraftMutationState } from "../itinerary/draftPublishStateMachine";
